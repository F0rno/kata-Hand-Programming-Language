...
* Implementa la función `increaseMemoryAddress(memory, memoryAddress)` para incrementar el valor de la celda de memoria actual

#### **3. Decrementa el valor de una posición de memoria `👇`**

* Implementa la función `decreaseMemoryAddress(memory, memoryAddress)` para disminuir el valor de la celda de memoria actual

#### **4. Incrementa el puntero de memoria `👉`**

* Implementa la función `increaseMemoryPointer(memory, memoryPointer)` para mover el puntero de memoria a la siguiente celda

#### **5. Decrementa el puntero de memoria `👈`**

* Implementa la función `decreaseMemoryPointer(memory, memoryPointer)` para mover el puntero de memoria a la celda anterior
